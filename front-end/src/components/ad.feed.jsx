...
export const AdFeed = () => {
    return (
        <div id="AdFeed">
            ...
            <div id="AdLogo">
                <ProfileImage image={"https://media-exp1.licdn.com/dms/image/C4D03AQE732pYOz74lw/profile-displayphoto-shrink_100_100/0/1649706029434?e=1663804800&v=beta&t=QuJxqFe_hwWQtwemok7NeSjOANgS0YHYrXqqdnuHbdw"} style={{position:"static",margin:"0px 14px"} } />
