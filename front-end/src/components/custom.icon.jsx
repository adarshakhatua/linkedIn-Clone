...
export const Photo = ({style}) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-supported-dps="24x24" fill="currentColor" class="mercado-match" width="24" height="24" focusable="false" style={style}>
...
// export const Celebrate_Reaction = () => {
//     return (
...
// export const Funny_Reaction = () => {
//     return (
        
//     )
// }
// export const Love_Reaction = () => {
//     return (
        
//     )
// }
// export const Insightful_Reaction = () => {
//     return (
